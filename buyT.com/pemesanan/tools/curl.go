...
func ServicesKereta(method, baseUrl string, requestBody []byte, data interface{}, header map[string][]string) error {
...
func ServicesRegister(method, baseUrl string, requestBody []byte, data interface{}, header map[string][]string) error {
